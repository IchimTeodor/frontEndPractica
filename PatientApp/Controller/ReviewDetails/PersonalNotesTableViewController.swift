//
//  PersonalNotesTableViewController.swift
//  PatientApp
//
...
class PersonalNotesTableViewController: UITableViewController {
    ...
    func loadNibs(){
        let nib = UINib.init(nibName: "PersonalNotesTableViewCell", bundle: nil)
